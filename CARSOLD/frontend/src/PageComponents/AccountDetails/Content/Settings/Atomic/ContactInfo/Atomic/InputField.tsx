...
const InputField: React.FC<InputFieldProps> = ({label, value, setValue, valueType, setFetch}) => {
    ...
    return (
        <div className="flex flex-col lg:gap-[1px] 2xl:gap-[2px]">
            ...
            <div className="flex flex-row w-fit text-sm xs:text-base lg:text-lg xl:text-xl
            2xl:text-2xl 3xl:test-3xl cursor-pointer"
                ...
                <div className="relative mr-5">
                    <div className={`flex items-center w-[150px] xs:w-[180px] sm:w-[140px] lg:w-[180px] xl:w-[200px]
                    2xl:w-[240px] 3xl:w-[270px] h-[21px] xs:h-[25px] lg:h-[29px] xl:h-[33px] 2xl:h-9 3xl:h-[38px]
                    px-[2px] xs:px-[3px] lg:px-[4px] xl:px-[5px] 2xl:px-[6px] 3xl:px-[7px] rounded-sm overflow-hidden 
                    ${!inputActive ? "border border-black border-opacity-30" : ""}`}>
                    {value}
                    </div>
                    {inputActive &&
                    <input className={`absolute inset-0 transition duration-300 ease-in-out focus:outline-none 
                    focus:ring-2 xs:focus:ring-[3px] 2xl:focus:ring-4 rounded-sm focus:ring-blue-500/30
                    focus:shadow-blue-500/50 px-[2px] xs:px-[3px] lg:px-[4px] xl:px-[5px] 2xl:px-[6px] 3xl:px-[7px]`}
                           ref={inputRef}
