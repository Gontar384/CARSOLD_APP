...
const PasswordChange: React.FC<PasswordChangeProps> = ({setIsChanged}) => {
    ...
    return (
        <div className="relative w-full max-w-[250px] xs:max-w-[290px] lg:max-w-[270px] xl:max-w-[290px]
        2xl:max-w-[370px] 3xl:max-w-[420px] -mb-6 xs:-mb-7 sm:-mb-8 lg:-mb-10 xl:-mb-14 2xl:-mb-16">
