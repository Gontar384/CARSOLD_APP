    ...
    return (
        ...
        xl:ml-4 2xl:mt-5 2xl:ml-5 3xl:mt-6 3xl:ml-6">
            ...
            <div className="flex flex-col gap-2 xs:gap-3 lg:gap-4 xl:gap-5 2xl:gap-6 3xl:gap-7">
                <InputField label="Name" value={name} setValue={setName} valueType="name" setFetch={setFetch} infoLoading={infoLoading}/>
                <InputField label="Phone" value={phone} setValue={setPhone} valueType="phone" setFetch={setFetch} infoLoading={infoLoading}/>
                <InputField label="City" value={city} setValue={setCity} valueType="city" setFetch={setFetch} infoLoading={infoLoading}/>
            </div>
            <SwitchButton/>
        </div>
    )
