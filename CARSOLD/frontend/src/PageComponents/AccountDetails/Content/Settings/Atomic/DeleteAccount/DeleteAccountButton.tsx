            ...
            <div className="flex flex-col items-center justify-center">
                <button className="flex"
                    ...
                    <FontAwesomeIcon icon={faDeleteLeft}
                                     className={`text-lg xs:text-xl lg:text-[22px] xl:text-2xl 2xl:text-[26px] 3xl:text-[28px] ${buttonAnimation}`}
                                     style={{color: "red", transform: "rotate(-180deg)"}}/>
                </button>
                <p className="text-[9px] xs:text-[10px] lg:text-[11px] xl:text-xs 2xl:text-[13px] 3xl:text-sm whitespace-nowrap">
                    Delete Account</p>
            </div>
        </div>
    )
