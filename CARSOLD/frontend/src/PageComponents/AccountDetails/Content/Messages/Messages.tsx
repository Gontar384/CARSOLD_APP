...
const Messages: React.FC = () => {
    ...
    return (
        ...
        ${bigWidth ? "flex-row mt-12" : "flex-col gap-[50px]"}`}>
            <div className={`${bigWidth ? "w-1/3 max-w-[470px] h-[620px]" : "w-full h-[520px] m:h-[600px] mb-[75px] order-2"}
            ...
            <div className={`${bigWidth ? "w-2/3 max-w-[830px] h-[620px]" : "w-full h-[520px] m:h-[600px] mt-[50px] order-1"}
            flex flex-col items-center`}>
