...
const BaseInfo: React.FC<BaseInfoProps> = ({title, price, currency, createdOn}) => {
    ...
    return (
        <div className="flex flex-col w-full m:w-[95%] mt-4 m:mt-12 px-4 m:px-5 py-6 m:py-7 gap-3 m:gap-4 bg-white
          border-y m:border-2 border-black border-opacity-40 m:rounded">
            <h2 className="text-3xl m:text-4xl break-words">{title}</h2>
