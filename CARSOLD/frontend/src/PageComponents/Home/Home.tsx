    ...
    return (
        <LayOut>
            <div className={`flex ${bigWidth ? "flex-row" : "flex-col items-center"} w-full h-full overflow-hidden relative`}>
                <div className={`flex flex-col bg-gradient-to-t from-darkLime to-lime animate-appearFastRev
                ...
                <div className={`flex flex-col items-center justify-center h-fit bg-gradient-to-t from-lime to-darkLime lg:from-darkLime lg:to-lime animate-appearFast
