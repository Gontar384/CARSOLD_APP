...
class OfferManagementControllerTest {
    ...
    public void fetchOffer() throws Exception {
        ...
        mockMvc.perform(get("/api/private/offer/fetch/1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.permission").value(true));
    }
    ...
    public void fetchAllUserOffers() throws Exception {
        ...
        when(offerManagementService.fetchAllUserOffers(0, 3)).thenReturn(page);

        mockMvc.perform(get("/api/private/offer/fetchAllForUser"))
                .andExpect(status().isOk())
    ...
    public void fetchOfferWithUser() throws Exception {
        ...
        mockMvc.perform(get("/api/public/offer/fetchWithUser/1"))
                .andExpect(status().isOk());
    }
    ...
    public void createOffer() throws Exception {
        ...
        mockMvc.perform(multipart("/api/private/offer/add")
                        .file(offerPart)
    ...
    public void updateOffer() throws Exception {
        ...
        mockMvc.perform(multipart("/api/private/offer/update/1")
                        .file(offerPart)
                        .contentType(MediaType.MULTIPART_FORM_DATA)
                        .with(request -> {
    ...
    public void deleteOffer() throws Exception {
        mockMvc.perform(delete("/api/private/offer/delete/1"))
                .andExpect(status().isOk());
    }
    ...
    public void fetchRandomOffers_shouldReturnListOfOffers() throws Exception {
        ...
        mockMvc.perform(get("/api/public/offer/fetchRandom"))
                .andExpect(status().isOk())
