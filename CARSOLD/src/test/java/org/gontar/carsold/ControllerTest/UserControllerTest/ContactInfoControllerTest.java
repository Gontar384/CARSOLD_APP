...
class ContactInfoControllerTest {
    ...
    public void updateName() throws Exception {
        ...
        mockMvc.perform(patch("/api/private/userContactInfo/updateName")
    ...
    public void updatePhone() throws Exception {
        ...
        mockMvc.perform(patch("/api/private/userContactInfo/updatePhone")
                        .contentType("application/json")
                        .content(new ObjectMapper().writeValueAsString(singleStringDto)))
                .andExpect(status().isOk());
    }
    ...
    public void updateCity() throws Exception {
        ...
        mockMvc.perform(patch("/api/private/userContactInfo/updateCity")
                        .contentType("application/json")
                        .content(new ObjectMapper().writeValueAsString(singleStringDto)))
                .andExpect(status().isOk());
    }
    ...
    public void fetchCitySuggestions() throws Exception {
        ...
        mockMvc.perform(get("/api/private/userContactInfo/fetchCitySuggestions")
                        .param("value", city))
                .andExpect(status().isOk())
    ...
    public void updateAndFetchContactPublic() throws Exception {
        ...
        mockMvc.perform(patch("/api/private/userContactInfo/updateAndFetchContactPublic")
                        .contentType("application/json")
    ...
    public void fetchContactInfo() throws Exception {
        ...
        mockMvc.perform(get("/api/private/userContactInfo/fetch"))
                .andExpect(status().isOk())
