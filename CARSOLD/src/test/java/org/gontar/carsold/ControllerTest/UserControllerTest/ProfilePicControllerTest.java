...
class ProfilePicControllerTest {
    ...
    public void fetchProfilePic() throws Exception {
        ...
        mockMvc.perform(get("/api/private/userProfilePic/fetch"))
    ...
    public void uploadProfilePic() throws Exception {
        ...
        mockMvc.perform(multipart("/api/private/userProfilePic/upload").file(file)
    ...
    public void deleteProfilePic() throws Exception {
        ...
        mockMvc.perform(delete("/api/private/userProfilePic/delete"))
                .andExpect(status().isOk());
    }
}
