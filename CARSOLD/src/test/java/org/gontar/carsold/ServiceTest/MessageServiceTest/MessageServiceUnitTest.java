...
public class MessageServiceUnitTest {
    ...
    public void activateConversation_user1_success() {
        ...
        when(userRepository.findByUsername("jane")).thenReturn(otherUser);
        when(conversationRepository.findByUsers(1L, 2L)).thenReturn(Optional.of(conversation));

        messageService.activateConversation("jane");
    ...
    public void sendMessage_success() {
        ...
        messageService.sendMessage("jane", "Hello!");

        verify(messageRepository).save(any(Message.class));
        verify(conversationRepository).save(conversation);
        verify(webSocketService).sendMessageToUser(eq("jane"), any());
    }

    @Test
    public void sendMessage_blockedBySelf() {
        ...
        assertThrows(WrongActionException.class, () -> messageService.sendMessage("jane", "Blocked message"));
    }
    ...
    public void deleteConversation_singleSide_success() {
        ...
        messageService.deleteConversation("jane");
    ...
    public void blockUnblockUser_toggleBlock_success() {
        ...
        messageService.blockUnblockUser("jane");
    ...
    public void makeSeen_user1_success() {
        ...
        messageService.makeSeen("jane");

        assertTrue(conversation.isSeenByUser1());
        verify(webSocketService).sendSeenStatus("john", "jane", true);
    }
    ...
    public void getConversationOnInitial_success() {
        ...
        ConversationWithUserDto dto = messageService.getConversationOnInitial("jane");
    ...
    public void getConversationOnInitial_notActivated_shouldThrowException() {
        ...
        assertThrows(ConversationNotFoundException.class, () ->
                messageService.getConversationOnInitial("jane"));
    }

    @Test
    public void getOlderMessages_success() {
        Message msg = new Message();
        ...
        PagedMessagesDto dto = messageService.getOlderMessages("jane", 0);
    ...
    @Test
    public void getOlderMessages_deletedConversation_shouldThrowException() {
        conversation.setActivatedByUser1(true);
        conversation.setDeletedByUser1(true);
        ...
        assertThrows(ConversationNotFoundException.class, () ->
                messageService.getOlderMessages("jane", 1));
    }
}