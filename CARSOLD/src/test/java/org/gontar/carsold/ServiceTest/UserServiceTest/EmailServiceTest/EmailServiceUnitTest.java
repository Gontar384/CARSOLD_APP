...
public class EmailServiceUnitTest {
    ...
    public void sendAccountActivationEmail_success() {
        ...
        emailService.sendAccountActivationEmail(email, username, link, false);
    ...
    public void sendPasswordRecoveryEmail_success() {
        ...
        emailService.sendPasswordRecoveryEmail(email, false);
    ...
    public void sendPasswordRecoveryEmail_failure_userNotFound() {
        ...
        assertThrows(UserNotFoundException.class, () -> emailService.sendPasswordRecoveryEmail(email, false));
    }
    ...
    public void sendPasswordRecoveryEmail_failure_userNotActive() {
        ...
        assertThrows(UserDataException.class, () -> emailService.sendPasswordRecoveryEmail(email, false));
    }
